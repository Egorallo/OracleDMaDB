...
BEGIN
    restore_students_log(TO_TIMESTAMP('2024-02-28 10:45:10', 'YYYY-MM-DD HH24:MI:SS'));
    
--    restore_students_log(TO_TIMESTAMP('2024-02-28 10:45:00', 'YYYY-MM-DD HH24:MI:SS'), INTERVAL '0 00:01:00' DAY TO SECOND);
